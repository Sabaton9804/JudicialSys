/*
  ...
  - You are about to drop the column `juezId` on the `procesos` table. All the data in the column will be lost.
...
CREATE TABLE "new_procesos" (
    ...
    CONSTRAINT "procesos_oficialMayorId_fkey" FOREIGN KEY ("oficialMayorId") REFERENCES "usuarios" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
